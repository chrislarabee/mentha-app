...
from app.domain.core import DomainModelType, InputModelType
...
class BasicRouter(Router, Generic[DomainModelType, InputModelType], ABC):
    def __init__(
        self,
        *,
        singular_name: str,
        ...
        input_model_decoder: Callable[[UUID, InputModelType], DomainModelType],
        table: MenthaTable[DomainModelType],
    ) -> None:
    ...
    @abstractmethod
    async def add(self, input: InputModelType) -> UUID:
        """
    ...
    async def get(self, id: UUID) -> DomainModelType:
    ...
    async def update(self, id: UUID, input: InputModelType) -> DomainModelType:
        ...
        Args:
            ...
            input (InputModelType): The InputModel to update the record from.

        Raises:
            NotFoundException: If the passed id cannot be found.

        Returns:
            DomainModelType: The updated model.
        """
